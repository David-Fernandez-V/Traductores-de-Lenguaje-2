...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("MainWindow", u"Tripletas", None))
        ___qtablewidgetitem = self.tableWidget_representacionIntermedia.horizontalHeaderItem(1)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"Operaci\u00f3n", None));
        ___qtablewidgetitem1 = self.tableWidget_representacionIntermedia.horizontalHeaderItem(2)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"Argumento 1", None));
        ___qtablewidgetitem2 = self.tableWidget_representacionIntermedia.horizontalHeaderItem(3)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Argumento 2", None));
        self.groupBox_3.setTitle(QCoreApplication.translate("MainWindow", u"Tabla de S\u00edmbolos", None))
        ___qtablewidgetitem3 = self.tableWidget_simbolos.horizontalHeaderItem(1)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Identificador", None));
    # retranslateUi

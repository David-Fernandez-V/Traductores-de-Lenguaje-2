...
class Interfaz(QMainWindow):
    ...
    def actualizar_tablas(self):
        self.limpiar_tablas()
        self.ui.tableWidget_representacionIntermedia.setRowCount(self.analizador_sintactico.tripletas.obtener_longitud())
        self.ui.tableWidget_simbolos.setRowCount(self.analizador_sintactico.tabla_simbolos.obtener_longitud())

        for row, nodo in enumerate (self.analizador_sintactico.tripletas.tripltes):
            posicion_item = QTableWidgetItem(str(row))
